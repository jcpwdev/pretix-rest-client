...
class PretixRestClient extends Client {
    ...
    public function getItems($event_id) {
        $this->findToken();

        try {
            $response = $this->get('organizers/' . $this->organizer_id .  '/events/' . $event_id . '/items/', $this->http_options);
        } catch (RequestException $req_exce) {
            return false;
        }
    ...
    public function getQuotasWithAvailability($event_id) {
        $this->findToken();

        try {
            $response = $this->get('organizers/' . $this->organizer_id .  '/events/' . $event_id . '/quotas/?with_availability=true', $this->http_options);
        } catch (RequestException $req_exce) {
            return false;
        }
